 ...
 */
const BUDGETS_KB = {
  "content.js": 695, // v1.17.1: 680 KB (round 3: streaks, map search, calendar stop, retries; 11 KB of template waste removed to fit), room for fixes; v1.16.0: 667 KB, of which 56 KB is the French catalog (784 texts, the English text is the key); v1.14.0: 599 KB (theme colours +12, upload-on-save editor +7, mobile and hub work); v1.13.0: 564 KB
