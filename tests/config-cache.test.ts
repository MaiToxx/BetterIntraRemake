...
const PROFILE_PAGE_STARTUP: Read[] = [
  ...
  [
    "LOGTIME_GOAL_HOURS", "LOGTIME_SHOW_AVERAGE", "LOGTIME_SHOW_GOAL", "LOGTIME_SHOW_RECORDS",
    "LOGTIME_SHOW_TACOS", "LOGTIME_EMOJI", "LOGTIME_EMOJI_DIVISOR", "LOGTIME_EMOJI_RATE", "LOGTIME_SHOW_DAYS_MODE",
