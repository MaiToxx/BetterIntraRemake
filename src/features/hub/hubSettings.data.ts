 ...
 */
const BG_PRESET_OPTIONS: readonly FeatureCardOption[] = [
...
export const HUB_SETTING_DEFS: Record<FeatureId, readonly HubSettingDef[]> = {
  ...
  profile: [
    ...
    // Public profile extras (src/features/profile/extras/extras.ts is the
    // contract). Everything typed here is read by strangers: the option
    // values and the maxLength below mirror the enums and LIMITS of the
    // contract (tests/hub-public-profile.test.ts enforces it), and the
    // sanitizer, not this form, is what makes a value safe to display.
    {
      feature: "profile",
